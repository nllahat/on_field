...
part of 'standings_table_row.entity.dart';
...
/// @nodoc
class _$StandingsTableRowTearOff {
  const _$StandingsTableRowTearOff();
...
/// @nodoc
const $StandingsTableRow = _$StandingsTableRowTearOff();

/// @nodoc
mixin _$StandingsTableRow {
  ...
  @JsonKey(ignore: true)
  $StandingsTableRowCopyWith<StandingsTableRow> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StandingsTableRowCopyWith<$Res> {
  factory $StandingsTableRowCopyWith(
          StandingsTableRow value, $Res Function(StandingsTableRow) then) =
      _$StandingsTableRowCopyWithImpl<$Res>;
  $Res call(
      {int position,
      Team team,
      int playedGames,
...
/// @nodoc
class _$StandingsTableRowCopyWithImpl<$Res>
    implements $StandingsTableRowCopyWith<$Res> {
  _$StandingsTableRowCopyWithImpl(this._value, this._then);

  final StandingsTableRow _value;
  // ignore: unused_field
  final $Res Function(StandingsTableRow) _then;
...
class __$StandingsTableRowCopyWithImpl<$Res>
    extends _$StandingsTableRowCopyWithImpl<$Res>
...
class _$_StandingsTableRow
    with DiagnosticableTreeMixin
    implements _StandingsTableRow {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'StandingsTableRow(position: $position, team: $team, playedGames: $playedGames, form: $form, won: $won, draw: $draw, lost: $lost, points: $points, goalsFor: $goalsFor, goalsAgainst: $goalsAgainst, goalDifference: $goalDifference)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'StandingsTableRow'))
...
abstract class _StandingsTableRow implements StandingsTableRow {
